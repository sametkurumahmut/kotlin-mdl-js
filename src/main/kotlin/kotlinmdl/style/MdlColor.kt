...
import kotlinmdl.material.style.IMaterialAccentShade
...
sealed class MdlColor : IMdlColor {
    ...
    sealed class Background : MdlColor(), IMdlBackgroundColor {
        ...
        class AmberAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--amber-${shade.value}"
        }
        ...
        class BlueAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--blue-${shade.value}"
        }
        ...
        class CyanAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--cyan-${shade.value}"
        }
        ...
        class DeepOrangeAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--deep-orange-${shade.value}"
        }
        ...
        class DeepPurpleAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--deep-purple-${shade.value}"
        }
        ...
        class GreenAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--green-${shade.value}"
        }
        ...
        class IndigoAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--indigo-${shade.value}"
        }
        ...
        class LightBlueAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--light-blue-${shade.value}"
        }
        ...
        class LightGreenAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--light-green-${shade.value}"
        }
        ...
        class LimeAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--lime-${shade.value}"
        }
        ...
        class OrangeAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--orange-${shade.value}"
        }
        ...
        class PinkAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--pink-${shade.value}"
        }
        ...
        class PurpleAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--purple-${shade.value}"
        }
        ...
        class RedAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--red-${shade.value}"
        }
        ...
        class TealAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--teal-${shade.value}"
        }
        ...
        class YellowAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Background() {
            override val value = "mdl-color--yellow-${shade.value}"
        }
    }
    ...
    sealed class Text : MdlColor(), IMdlTextColor {
        ...
        class AmberAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--amber-${shade.value}"
        }
        ...
        class BlueAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--blue-${shade.value}"
        }
        ...
        class CyanAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--cyan-${shade.value}"
        }
        ...
        class DeepOrangeAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--deep-orange-${shade.value}"
        }
        ...
        class DeepPurpleAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--deep-purple-${shade.value}"
        }
        ...
        class GreenAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--green-${shade.value}"
        }
        ...
        class IndigoAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--indigo-${shade.value}"
        }
        ...
        class LightBlueAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--light-blue-${shade.value}"
        }
        ...
        class LightGreenAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--light-green-${shade.value}"
        }
        ...
        class LimeAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--lime-${shade.value}"
        }
        ...
        class OrangeAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--orange-${shade.value}"
        }
        ...
        class PinkAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--pink-${shade.value}"
        }
        ...
        class PurpleAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--purple-${shade.value}"
        }
        ...
        class RedAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--red-${shade.value}"
        }
        ...
        class TealAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--teal-${shade.value}"
        }
        ...
        class YellowAccent(shade: IMaterialAccentShade = MaterialShade.Accent.A200()) : Text() {
            override val value = "mdl-color-text--yellow-${shade.value}"
        }
    }
