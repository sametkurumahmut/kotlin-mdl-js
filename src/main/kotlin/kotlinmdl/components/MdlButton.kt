...
open class MdlButton(
        element: HTMLButtonElement,
        buttonColor: IMdlButtonColor? = null,
        hasRippleEffect: Boolean = MdlConfig.hasRippleEffect,
        classes: String = String.empty)
    : MdlButtonBase<HTMLButtonElement>(element, buttonColor, hasRippleEffect, classes) {
    ...
    constructor(
            ...
            hasRippleEffect: Boolean = MdlConfig.hasRippleEffect,
            classes: String = String.empty)
            : this(document.create.button(formEncType, formMethod, name, type), buttonColor, hasRippleEffect, classes)
}
