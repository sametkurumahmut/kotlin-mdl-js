...
open class MdlIconToggleInput(element: HTMLInputElement, id: String, classes: String = String.empty)
    : MdlIconToggleInputBase<HTMLInputElement>(element, id, classes) {
