...
open class MdlColoredFloatingActionButtonLink(
        element: HTMLAnchorElement,
        icon: IMdlMaterialIcon<Element>? = null,
        hasRippleEffect: Boolean = MdlConfig.hasRippleEffect,
        classes: String = String.empty)
    : MdlFloatingActionButtonBase<HTMLAnchorElement>(element, icon, MdlButtonColor.COLORED, hasRippleEffect, classes) {
